...
class DateResolverDialog_START(CancelAndHelpDialog):
    ...
    def __init__(
        ...
        super(DateResolverDialog_START, self).__init__(
            dialog_id or DateResolverDialog_START.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client
        print("DateResolverDialog START INIT ",  )
    ...
    async def initial_step(
        ...
        prompt_msg = "what date do you want to leave?"
        reprompt_msg = (
            "I'm sorry, for best results, please enter your travel "
            "date including the year the month and the day, e.g 2022-10-27"
        )
        print("TIMEX  ", timex.__str__)
        if timex is None:
    ...
    async def datetime_prompt_validator(prompt_context: PromptValidatorContext) -> bool:
        ...
        print("datetime_prompt_validator", prompt_context.recognized.value[0])
